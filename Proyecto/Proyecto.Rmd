...
CValidation <- function(train,ltrain){
  ...
  #5 subconjuntos
  train1 <- cbind(train.l1[1:length(train)/5], train.l2[1:length(train)/5])
  train2 <- cbind(train.l1[length(train)/5 : 2*length(train)/5],train.l2[length(train)/5 : 2*length(train)/5])
  train3 <- cbind(train.l1[ 2*length(train)/5:  3*length(train)/5],train.l2[2*length(train)/5: 3*length(train)/5])
  train4 <- cbind(train.l1[3 * length(train)/5:  4 * length(train)/5], train.l2[3*length(train)/5:  4 * length(train)/5])
  train5 <- cbind(train.l1[4 * length(train)/5:   length(train)], train.l2[4 * length(train)/5:   length(train)])
...
#1, no 1
lhar.train.1 <- lhar.train
lhar.test.1 <- lhar.test
lhar.train.1[lhar.train.1 != 1] <- 0
#lhar.test.1[lhar.test.1 != 1] <- 0
CValidation(har.train, lhar.train.1)
