...
Por la regla de la cadena, $\frac{\partial}{\partial y_j} = \frac{\partial}{z_k}\frac{\partial}{y_j}$, para cada $k = 1,\dots,n_O$. Aplicando esto a la expresión anterior, obtenemos:
