...
model_errors <- c(Eout.linear,Eout.svm,Eout.rf)
model_confussions <- list(confussion.linear,confussion.svm,confussion.rf)
model_names <- c("Lineal - Poisson", "SVM", "Random Forest")
