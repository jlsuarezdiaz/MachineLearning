...
models <- list(ml.binomial1, ml.binomial2, ml.binomial3, ml.gaussian1, ml.gaussian2, ml.gaussian3, ml.poisson1, ml.quasi1, ml.quasibinomial1, ml.quasipoisson1)
...
```{r, echo=F,warning=F}
  ...
  ml_lasso <- cv.glmnet(as.matrix(sahd.train), lsahd.train, family="binomial")
  ...
  coeffs <- coef(ml_lasso, s=ml_lasso$lambda.min)


  #Prefijamos un umbral (cual?)
```
